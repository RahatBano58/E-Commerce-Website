...
const Header = () => {
  ...
  return (
    <header className="bg-black font-serif font-extrabold  shadow-lg py-4 sticky top-0 z-50">
      <div className="container mx-auto flex justify-between items-center px-4">
        {/* Logo */}
        <div className="flex items-center text-white text-2xl hover:scale-105 transition-transform duration-300">
          <h1>Fashion Store</h1>
        </div>
        ...
        >
          <Link
            href="/"
            className="block md:inline-block text-white hover:bg-red-500 hover:underline py-2 px-4"
          >
            Home
          </Link>
          <Link
            href="/About"
            className="block md:inline-block  text-white hhover:bg-red-500 hover:underline py-2 px-4"
          >
            About
          </Link>
          <Link
